...
class CaesarAIContractQA(object):
    """
    CaesarAIContractQA is a class for processing and interacting with documents, embeddings, and question-answering chains.
    Attributes:
    ...
    Methods:
        ...
        ask_question(question, repo_id="declare-lab/flan-alpaca-large", chain_type="stuff", relevant_docs=None, with_score=False, temperature=0, max_length=300, language="Spanish"): Answer a question using relevant documents and a question-answering chain.
    ...
    """
    def __init__(self, data_source_path=None, data_text=None, OPENAI_KEY=None) -> None:
        """
        Initialize the CaesarAIContractQA instance.
        ...
        self.HF_API_TOKEN = base64.b64decode(os.environ.get("HF_API_TOKEN")).decode()
        self.db = None
        self.llm = None
        self.chain = None
        self.repo_id = None
...
if __name__ == "__main__":
    ...
    caesaraiqa = CaesarAIContractQA(data_source_path="sample-privacy-policy-template.pdf",)
    caesaraiqa.create_db_document(data_source_type="PDF")

    question = "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"
    res  =  caesaraiqa.ask_question(question=question, language="ENGLISH")
    print(res)
